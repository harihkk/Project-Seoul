...
// (or a row without a type) fails the build.
constexpr ComponentTypeInfo kCatalog[] = {
    // Foundation.
    {ComponentType::kText, "text", ComponentCategory::kFoundation, false, false,
     false, false, kBindNone, false, kTextProps, 1},
    ...
    {ComponentType::kBadge, "badge", ComponentCategory::kFoundation, false,
     false, false, false, kBindNone, false, kTextProps, 1},
    {ComponentType::kIcon, "icon", ComponentCategory::kFoundation, false, false,
     false, false, kBindNone, false, kIconProps, 1},
    {ComponentType::kImage, "image", ComponentCategory::kFoundation, false,
     false, false, false, kBindNone, false, kImageProps, 2},
    {ComponentType::kLink, "link", ComponentCategory::kFoundation, false, false,
     false, false, kBindNone, false, kLinkProps, 2},
    ...
    {ComponentType::kRow, "row", ComponentCategory::kLayout, true, false, false,
     false, kBindNone, false, nullptr, 0},
    ...
    {ComponentType::kHistogram, "histogram", ComponentCategory::kChart, false,
     false, true, true, kBindSeries | kBindTable, true, kChartProps, 4},
    // Domain: weather.
    {ComponentType::kWeatherCurrent, "weather_current",
     ComponentCategory::kDomain, false, false, false, true, kBindRecord, true,
     nullptr, 0},
    {ComponentType::kWeatherHourly, "weather_hourly",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kWeatherDaily, "weather_daily", ComponentCategory::kDomain,
     false, false, false, true, kBindTable, true, nullptr, 0},
    {ComponentType::kWeatherAlert, "weather_alert", ComponentCategory::kDomain,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    // Domain: markets.
    {ComponentType::kSecurityQuote, "security_quote",
     ComponentCategory::kDomain, false, false, false, true, kBindRecord, true,
     nullptr, 0},
    {ComponentType::kWatchlistControl, "watchlist_control",
     ComponentCategory::kDomain, false, true, false, true, kBindNone, false,
     kLabelProps, 1},
    // Domain: products.
    {ComponentType::kProductCard, "product_card", ComponentCategory::kDomain,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kSellerCard, "seller_card", ComponentCategory::kDomain,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kPriceComparison, "price_comparison",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    // Domain: travel.
    {ComponentType::kLocationCard, "location_card", ComponentCategory::kDomain,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kRouteCard, "route_card", ComponentCategory::kDomain, false,
     false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kItineraryCard, "itinerary_card",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kFlightCard, "flight_card", ComponentCategory::kDomain,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kHotelCard, "hotel_card", ComponentCategory::kDomain, false,
     false, false, true, kBindRecord, true, nullptr, 0},
    // Domain: calendar.
    {ComponentType::kAgendaView, "agenda_view", ComponentCategory::kDomain,
     false, false, false, true, kBindTable, true, nullptr, 0},
    {ComponentType::kAvailabilityGrid, "availability_grid",
     ComponentCategory::kDomain, false, true, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kEventCard, "event_card", ComponentCategory::kDomain, false,
     false, false, true, kBindRecord, true, nullptr, 0},
    // Domain: research.
    {ComponentType::kSourceCard, "source_card", ComponentCategory::kDomain,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kEvidenceTable, "evidence_table",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kClaimComparison, "claim_comparison",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kCitationGraph, "citation_graph",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kOutline, "outline", ComponentCategory::kDomain, false,
     false, false, true, kBindTable, false, nullptr, 0},
    {ComponentType::kReportPreview, "report_preview",
     ComponentCategory::kDomain, true, false, false, true, kBindNone, false,
     kTitleProps, 1},
    // Domain: files.
    {ComponentType::kFileCard, "file_card", ComponentCategory::kDomain, false,
     false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kAttachmentList, "attachment_list",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    {ComponentType::kDocumentViewer, "document_viewer",
     ComponentCategory::kDomain, false, false, false, true, kBindRecord, true,
     nullptr, 0},
    {ComponentType::kImageGallery, "image_gallery", ComponentCategory::kDomain,
     false, false, false, true, kBindTable, true, nullptr, 0},
    {ComponentType::kExtractionTable, "extraction_table",
     ComponentCategory::kDomain, false, false, false, true, kBindTable, true,
     nullptr, 0},
    // Workflow.
    ...
    {ComponentType::kWorkflowNode, "workflow_node",
     ComponentCategory::kWorkflow, false, false, false, true, kBindRecord, true,
     nullptr, 0},
    {ComponentType::kTriggerCard, "trigger_card", ComponentCategory::kWorkflow,
     false, false, false, true, kBindRecord, true, nullptr, 0},
    {ComponentType::kParameterForm, "parameter_form",
     ComponentCategory::kWorkflow, true, false, false, true, kBindNone, false,
     nullptr, 0},
    ...
    {ComponentType::kLogViewer, "log_viewer", ComponentCategory::kCode, false,
     false, false, true, kBindTable, false, nullptr, 0},
    {ComponentType::kStackTrace, "stack_trace", ComponentCategory::kCode, false,
     false, false, false, kBindTable, false, nullptr, 0},
    {ComponentType::kFileTree, "file_tree", ComponentCategory::kCode, false,
     false, false, true, kBindTable, true, nullptr, 0},
    {ComponentType::kApiResultTable, "api_result_table",
     ComponentCategory::kCode, false, false, false, true, kBindTable, true,
     nullptr, 0},
};

// The table must cover the enum exactly, in declaration order (kApiResultTable
// is the last enum value; keep it last when extending both).
static_assert(std::size(kCatalog) ==
                  static_cast<size_t>(ComponentType::kApiResultTable) + 1,
